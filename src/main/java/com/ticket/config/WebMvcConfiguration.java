...
import com.ticket.json.JacksonObjectMapper;
...
public class WebMvcConfiguration extends WebMvcConfigurationSupport {
    ...
    protected void addInterceptors(InterceptorRegistry registry) {
        ...
        registry.addInterceptor(jwtTokenAdminInterceptor) //那个拦截器
                ...
                .excludePathPatterns("/admin/login", "/admin/logout", "/admin/export","/admin/park/config/**"); //那些路径不拦截

        registry.addInterceptor(jwtTokenUserInterceptor)
                .addPathPatterns("/user/**")
                .excludePathPatterns("/user/login", "/admin/park/config/**");
    }
    /*
